        ...
        <div className='px-4 py-36 lg:py-64 md:w-10/12 mx-auto lg:h-screen items-stretch w-full'>
          <div className='lg:h-full flex flex-col justify-center'>
            <div className="flex flex-col justify-center items-center w-full">
              <h2 className="text-3xl text-white font-bold uppercase border-b-2 border-white">Know Me More</h2>
            </div>
            <div className='flex flex-col lg:flex-row'>
              <div className='w-full lg:w-3/4 lg:pr-8'>
                ...
                <div className='flex justify-start'>
                  <Link to="contact" smooth={true} duration={500} className="rounded-lg cursor-pointer border-2 border-sky-600 hover:border-white text-sky-600 hover:text-white bg-white hover:bg-sky-600 px-4 py-2 mt-8 flex justify-center items-center">
                    Contact Me<HiArrowNarrowRight className='ml-3' />
                  </Link>
                  <a href={DownloadResume} target='_blank' className="rounded-lg cursor-pointer border-2 border-white hover:border-sky-600 text-white hover:text-sky-600 bg-sky-600 hover:bg-white px-4 py-2 mt-8 flex justify-center items-center ml-4">
              ...
              <div className='w-full lg:w-1/3'>
                <div className='flex flex-row flex-wrap pt-16 lg:pt-8'>
                  <div className='w-full mb-4'>
                    <div className='bg-white border-2 border-sky-600 p-4 rounded-xl shadow-lg'>
                  ...
                  <div className='w-1/2'>
                    <div className='mr-2'>
                      <div className='bg-white border-2 border-sky-600 p-4 rounded-xl shadow-lg'>
                        <div className="flex flex-col items-center justify-center">
                          <h3 className="mb-2 text-4xl lg:text-5xl font-extrabold text-sky-600">100+</h3>
                  ...
                  <div className='w-1/2'>
                    <div className='ml-2'>
                      <div className='bg-white border-2 border-sky-600 p-4 rounded-xl shadow-lg'>
                        <div className="flex flex-col items-center justify-center">
                          <h3 className="mb-2 text-4xl lg:text-5xl font-extrabold text-sky-600">04+</h3>
