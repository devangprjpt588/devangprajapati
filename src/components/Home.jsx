    ...
    <div name="home" className='container mx-auto'>
        <div className='p-4 pt-20 xl:w-10/12 mx-auto flex flex-col-reverse md:flex-row items-center w-full justify-center h-screen'>
            <div className='lg:w-2/3 flex flex-col'>
              ...
              <div className='flex'>
                <Link to="skills" smooth={true} duration={500} className='group rounded-lg border-2 border-sky-600 text-sky-600 hover:text-white hover:bg-sky-600 px-4 py-2 flex justify-center items-center'>My Skills <span className='group-hover:rotate-90 duration-300'><HiArrowNarrowRight className='ml-3'/></span></Link>
